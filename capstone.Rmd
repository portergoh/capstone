...
We will explore the relationship of non-landed private residential properties rental rates using these 3 metrices to build our predictive model.
...
Let's us take a closer look on district 05, 10 and 11 using a lollipop chart.
...
<br>
Reviewing the geographical location, it appears that the highest and lowest rental yield for condo are at the opposite end for each district.
